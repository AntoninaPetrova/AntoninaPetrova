# Игра в конфеты. Человек против умного бота (у меня Умный Чебурашка):
...
player2 = 'Умный Чебурашка' 
value = 2021
flag = randint(0,2) 
if flag:
    print(f"Первый ходит {player1}")
else:
    print('Первый ходит Умный Чебурашка')
...
if flag:
    ...
    print(f"Выиграл Умный Чебурашка, а вам повезет в следующий раз!")